...
-- WHERE S.CardID = '3150300174300'
	-- ;
	-- select TOP 1 * from [dbo].[ccd_person] where cid = '3150300174300'
	-- select top 10 * from medalery WHERE delFlag IS NULL
	-- select DISTINCT top 10 count(*),hn from medalery where delFlag IS NULL GROUP BY hn,medCode order by count(*) DESC;
